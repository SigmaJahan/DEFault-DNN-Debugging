...
subject_params = {'mnist': {'epochs': 10, 'lower_lr': 0.001, 'upper_lr': 1},
                  'movie_recomm': {'epochs': 5, 'lower_lr': 0.0001, 'upper_lr': 0.001},
                  'audio': {'epochs': 5, 'lower_lr': 0.0001, 'upper_lr': 0.001, 'patience': 10},
                  'lenet': {'epochs': 5, 'lower_lr':  0.001, 'upper_lr': 0.01},
                  'udacity': {'epochs': 5, 'lower_lr':  0.00001, 'upper_lr': 0.0001}
                  }
