...
data = pd.read_csv('..\\activation_correct_data.csv')
df_combined = data.copy()
df_combined['label'] = df_combined['label'].apply(lambda x: 1 if x == 'Activation' else 0)
...
print("OOB Score of Best Model Activation: ", best_clf.oob_score_)
print("Best Parameters Activation: ", grid_search.best_params_)

#new add
def evaluate_activation_sample(sample):
    """
