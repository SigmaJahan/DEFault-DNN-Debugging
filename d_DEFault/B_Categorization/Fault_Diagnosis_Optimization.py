...
data = pd.read_csv("..\\Optimization_correct_data.csv")
...
print("OOB Score of Best Model Optimization: ", best_clf.oob_score_)
print("Best Parameters Optimization: ", grid_search.best_params_) 


def evaluate_optimization_sample(sample):
    """
